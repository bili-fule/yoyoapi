...
export async function getBindCode(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
...
export async function confirmBind(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
...
export async function unbindQq(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
